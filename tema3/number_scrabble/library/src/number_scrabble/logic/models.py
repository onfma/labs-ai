# number_scrabble/logic/models.py
...
from number_scrabble.logic.exceptions import InvalidMove, UnknownGameScore
from number_scrabble.logic.validators import validate_game_state, validate_grid
