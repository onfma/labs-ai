# number_scrabble/game/engine.py

from dataclasses import dataclass
from typing import Callable, TypeAlias

from number_scrabble.game.players import Player
from number_scrabble.game.renderers import Renderer
from number_scrabble.logic.exceptions import InvalidMove
from number_scrabble.logic.models import GameState, Grid, Mark
from number_scrabble.logic.validators import validate_players
